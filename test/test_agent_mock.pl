...
test_mock_agent :-
    agent_discover_skills(Discovered, [skills_dir="python/scryer_agent/skills"]),
    ...
    agent_load_skill(mock_agent, 'shell-safety-exec', [skills_dir="python/scryer_agent/skills"]),
    agent_load_plugin(mock_agent, 'scryer_agent.plugins:memory_compress_plugin', [max_messages=12, keep_tail=6]),
