...
def _ensure_python_runtime_path() -> None:
    py_dir = pathlib.Path(__file__).resolve().parents[2]
...
from ..tool_runtime import tool_list_available  # noqa: E402
...
def list_skills(skills_dir: str = "python/scryer_agent/skills") -> list[dict[str, Any]]:
...
def create_or_replace_agent(
    ...
    skills_dir: str = "python/scryer_agent/skills",
) -> dict[str, Any]:
...
def reset_agent(name: str) -> dict[str, Any]:
    ...
    skills_dir = str(cfg.get("skills_dir", "python/scryer_agent/skills"))
