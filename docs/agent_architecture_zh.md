...
│  python/scryer_agent_runtime.py                           │
│  python/scryer_tool_runtime.py                            │
│  python/scryer_llm_runtime.py                             │
│  python/scryer_agent_config.py                            │
└────────────────────────────────────────────────────────────┘
```
...
文件：`python/scryer_agent_runtime.py`
...
文件：`python/scryer_tool_runtime.py`
...
文件：`python/scryer_agent_config.py`

核心能力：

- 读取 `python/config/agent_profiles.json`
- 可选读取 `python/config/agent_profiles.local.json` 并深度合并
...
1. 调用时显式 options
2. profile 字段（`agent_profiles.json` + `.local`）
